TokoVoipConfig = {
	...
	-- Main
	wsServer = "82.208.16.228:33250", -- Address of the websocket server	
	-- LOCAL	
	-- wsServer = "82.209.20.106:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "NoNameRP",
		TSPassword = "z9kpY2jqKExqBz", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Čekárna na letenku", -- You NEED tokovoip in the wait channel name!

		-- Blocking screen informations
		TSServer = "ts.nnrp.cz", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "http://voip.itokoyamato.net", -- Download link displayed on blocking screen
		...
		ClickVolume = -26, -- Set the radio clicks volume, -15 is a good default
