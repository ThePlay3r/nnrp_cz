...
if Config.SqlKeybinding then
  MySQL.ready(function()
	...
	AddEventHandler("dp:ServerKeybindUpdate", function(key, e)
		...
		if chosenk == "keybind1" then
			MySQL.Async.execute("UPDATE dpkeybinds SET e1=@e WHERE id=@id", {id = myid, e = e}, function() TriggerClientEvent("dp:ClientKeybindGetOne", src, key, e) end)
		elseif chosenk == "keybind2" then
			MySQL.Async.execute("UPDATE dpkeybinds SET e2=@e WHERE id=@id", {id = myid, e = e}, function() TriggerClientEvent("dp:ClientKeybindGetOne", src, key, e) end)
		elseif chosenk == "keybind3" then
			MySQL.Async.execute("UPDATE dpkeybinds SET e3=@e WHERE id=@id", {id = myid, e = e}, function() TriggerClientEvent("dp:ClientKeybindGetOne", src, key, e) end)
		elseif chosenk == "keybind4" then
			MySQL.Async.execute("UPDATE dpkeybinds SET e4=@e WHERE id=@id", {id = myid, e = e}, function() TriggerClientEvent("dp:ClientKeybindGetOne", src, key, e) end)
		elseif chosenk == "keybind5" then
			MySQL.Async.execute("UPDATE dpkeybinds SET e5=@e WHERE id=@id", {id = myid, e = e}, function() TriggerClientEvent("dp:ClientKeybindGetOne", src, key, e) end)
		elseif chosenk == "keybind6" then
			MySQL.Async.execute("UPDATE dpkeybinds SET e6=@e WHERE id=@id", {id = myid, e = e}, function() TriggerClientEvent("dp:ClientKeybindGetOne", src, key, e) end)
		end
	end)
  end)
else
