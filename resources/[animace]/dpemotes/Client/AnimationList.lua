...
DP.Shared = {
   ...
   ["sex"] = {"rcmpaparazzo_2", "shag_loop_a", "Sex", "sex2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
       EmoteFreeze = true,
       SyncOffsetFront = -0.25,
       SyncHeading = 355
   }},
   ["sex2"] = {"rcmpaparazzo_2", "shag_loop_poppy", "Sex 2", "sex", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
       EmoteFreeze = true,
   ...
   ["handshake"] = {"mp_ped_interaction", "handshake_guy_a", "Handshake", "haSndshake2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000,
       SyncOffsetFront = 0.9
