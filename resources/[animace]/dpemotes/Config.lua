...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "http://cloud.feio.cz/menubg2.png",
-- You can change the menu position here
	MenuPosition = "left", -- (left, right)
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 19, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Emoce',
        ['danceemotes'] = "🕺 Tance",
        ['propemotes'] = "📦 Animace s objekty",
        ['favoriteemotes'] = "🌟 Oblibene",
        ['favoriteinfo'] = "Vyberte zde emoce a nastavte ji jako oblibenou.",
        ['rfavorite'] = "Resetovat oblibene",
        ['prop2info'] = "❓ Prop Emotes lze nalezt na konci",
        ['set'] = "Set (",
        ['setboundemote'] = ") byt vasi svazanou emoci?",
        ['newsetemote'] = "~w~ je nyni vase vazana emoce, stisknete ~g~F5~w~ k pouziti.",
        ['cancelemote'] = "Zrusit emoci",
        ['cancelemoteinfo'] = "~r~X~w~ Zrusi aktualnu emoci",
        ['walkingstyles'] = "Styl chuze",
        ['resetdef'] = "Nastavit zakladni",
        ['normalreset'] = "Normalni (Reset)",
        ['moods'] = "Styl vyrazu",
        ...
        ['nocancel'] = "Zadna emoce k zruseni.",
        ['maleonly'] = "Tahle emoce je pouze pro muze!",
        ['emotemenucmd'] = "Pouzi /emotemenu k otevreni menu.",
        ['shareemotes'] = "👫 Emoce pro 2",
        ['shareemotesinfo'] = "Pozvete blizkou osobu k emoci",
        ['sharedanceemotes'] = "🕺 Tance pro 2",
        ['notvalidsharedemote'] = "Neplatne sdilene emoce.",
        ['sentrequestto'] = "Pozadavek odeslan ~y~",
        ['nobodyclose'] = "Nikdo ~r~neni~w~ pobliz.",
        ['doyouwanna'] = "~y~Z~w~ k prijmuti, ~r~L~w~ k odmitnuti (~g~",
        ['refuseemote'] = "Odmitnul emoci.",
        ['makenearby'] = "prinuti hrace v okoli hrat emoci",
        ['camera'] = "Stiskni ~y~H~w~ k blesku od fotoaparatu.",
        ['makeitrain'] = "Stiskni ~y~H~w~ k vyhazovani penez.",
        ['pee'] = "Stiskni ~y~H~w~ k curani.",
        ['spraychamp'] = "Drz ~y~H~w~ strikani sampanskeho",
        ['bound'] = "Vazany ",
        ['to'] = "k",
        ['currentlyboundemotes'] = " V soucasne dobe vazane emoce:",
        ['notvalidkey'] = "Neni povoleni klic.",
        ['keybinds'] = "🔢 Keybinds",
        ['keybindsinfo'] = "Pouzit"
  },
  ['fr'] = {
