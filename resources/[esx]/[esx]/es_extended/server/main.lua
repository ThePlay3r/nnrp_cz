...
AddEventHandler('playerDropped', function(reason)
	...
	if xPlayer then
		...
		local url = 'https://discordapp.com/api/webhooks/702504610102771762/VVkOHEFobA2I68n_Vpo1g61p77AMYndXWtW3aXkvh_cvFwFpj93iOb10omHLNW5wnH5k'
		local msg = '**[ID:' .. source .. ']** Hráč **' .. xPlayer.getName() .. '** **[HEX: ' .. xPlayer.identifier .. ']** se odpojil. (Důvod: **' .. reason .. '**)'
...
RegisterServerEvent('esx:giILovePizzaveInventoryItem')
AddEventHandler('esx:giILovePizzaveInventoryItem', function(target, type, itemName, itemCount)
	local _source = source
