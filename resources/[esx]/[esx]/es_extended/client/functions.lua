...
ESX.Game.SetVehicleProperties = function(vehicle, props)
	...
	if props.neonColor ~= nil then
		...
		if not fixedColor.r or not fixedColor.g or not fixedColor.b then
			fixedColor = {
				r = props.neonColor[1],
				g = props.neonColor[2],
				b = props.neonColor[3],
		...
		SetVehicleNeonLightsColour(vehicle, fixedColor.r, fixedColor.g, fixedColor.b)
	end
	...
	if props.tyreSmokeColor ~= nil then
		local fixedColor = {
			r = props.tyreSmokeColor['1'],
			g = props.tyreSmokeColor['2'],
			b = props.tyreSmokeColor['3'],
		}
		...
		SetVehicleTyreSmokeColor(vehicle, fixedColor.r, fixedColor.g, fixedColor.b)
	end
