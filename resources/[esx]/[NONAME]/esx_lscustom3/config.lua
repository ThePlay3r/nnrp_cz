...
Config.Locale = 'en'
Config.IsadminJobOnly = true

Config.Zones = {

	ls1 = {
		Pos   = { x = -900.92, y = -229.84, z = 38.95},
	...
	ls5 = {
		Pos   = { x = 1752.93, y = 3235.02, z = 42.05},
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {0.00001, 0.00001, 0.00001, 0.00001}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
	...
	modTransmission = {
		...
		parent = 'upgrades',
		modType = 13,
		price = {0.00001, 0.00001, 0.00001}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {0.00001, 0.00001, 0.00001, 0.00001, 0.00001}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {0.00001, 0.00001, 0.00001, 0.00001, 0.00001, 0.00001}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
