...
function GetAction(data)
	...
	for k,v in pairs(Config.Menus) do
      ...
      --END LIVERY FIX by DefaultLuca
				...
				if
					data.value == 'primaryRespray' or data.value == 'secondaryRespray' or data.value == 'pearlescentRespray' or data.value == 'modFrontWheelsColor' or
					data.value == 'dashboardColor' or data.value == 'interiorColor'
				then
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			local zone 		  = nil
			local lastZone    = nil
			if (PlayerData.job ~= nil and PlayerData.job.name == 'admin') or (PlayerData.job ~= nil and PlayerData.job.name == 'admin') or Config.IsmechanicJobOnly == false then
