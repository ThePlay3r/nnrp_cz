...
Config.CostMultiplier = 3.5

-- Configure the strings as you wish here.
Config.Strings = {
	ExitVehicle = "Vystup z vozidla pro natankování",
	ExitVehicleEle = "Vystup z vozidla pro nabijeni",
	EToRefuel = "Stiskni ~g~E ~w~pro tankovani vozidla",
	EToRefuelEle = "Stiskni ~g~E ~w~pro nabijeni vozidla",
	JerryCanEmpty = "Kanystr je prazdny",
	FullTank = "Nadrz je plna",
	PurchaseJerryCan = "Stiskni ~g~E ~w~pro zakoupeni kanystru za ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Stiskni ~g~E ~w~pro ukonceni tankovani",
	CancelFuelingPumpEle = "Stiskni ~g~E ~w~pro ukonceni nabijeni",
	CancelFuelingJerryCan = "Stiskni ~g~E ~w~pro ukonceni tankovani",
	NotEnoughCash = "Nemas dost penez",
	RefillJerryCan = "Stiskni ~g~E ~w~ pro doplneni kanystru.",
	NotEnoughCashJerryCan = "Nemas dost penez na doplneni kanystru",
	JerryCanFull = "Kanystr je plny",
	TotalCost = "Cena",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Stiskni ~g~E ~w~ k zakoupeni kanystru"
	Config.Strings.RefillJerryCan = "Stiskni ~g~E ~w~ k doplneni kanystru"
end
...
Config.SuperchargerModel = 1467552538
