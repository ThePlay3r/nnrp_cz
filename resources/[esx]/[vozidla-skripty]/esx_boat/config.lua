...
Config.Vehicles = {
	{model = 'suntrap', label = 'Suntrap', price = 100000},
	{model = 'tropic2', label = 'Tropic', price = 200000},

	{model = 'dinghy2', label = 'Dinghy (Cerna)', price = 250000},
	{model = 'dinghy', label = 'Dinghy (Nahodna barva)', price = 250000},

	{model = 'squalo', label = 'Squalo', price = 300000},
	{model = 'speeder', label = 'Speeder', price = 500000},
	{model = 'toro', label = 'Toro', price = 600000},
	{model = 'jetmax', label = 'Jetmax', price = 700000},
	
	{model = 'marquis', label = 'Plachetnice', price = 1200000},
	{model = 'submersible', label = 'Ponorka', price = 3500000},
}
