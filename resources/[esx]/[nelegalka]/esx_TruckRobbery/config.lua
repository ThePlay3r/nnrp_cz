...
Config.HackingSeconds = 35						-- seconds to hack
...
Config.MaxReward = 350000						-- set maximum reward amount
...
Config.ItemName2 = "zdezadejjmenoitemu"				-- exact name of your item2
...
Config.Item2Message = "Ziskal jsi ~b~%sx~s~ Net Cracker  ~y~Armored Truck~s~"
...
-- ProgressBars text
Config.Progress1 = "ZÍSKÁVÁNÍ GPS LOKACE"
Config.Progress2 = "POKLÁDÁNÍ C4"
Config.Progress3 = "ČAS DO VÝBUCHU"
Config.Progress4 = "VYKRÁDÁNÍ VOZIDLA"

-- ProgressBar Timers, in seconds:
Config.RetrieveMissionTimer = 7.5	-- time from pressed E to receving location on the truck
Config.DetonateTimer = 27			-- time until bomb is detonated
Config.RobTruckTimer = 30			-- time spent to rob the truck

-- Guards Weapons:
Config.DriverWeapon = "WEAPON_CARBINERIFLE"		-- weapon for driver
Config.PassengerWeapon = "WEAPON_CARBINERIFLE" 			-- weapon for passenger
