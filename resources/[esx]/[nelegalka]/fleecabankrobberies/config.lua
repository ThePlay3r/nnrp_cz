...
Config.AlertInChatMessage = "'BEZPEČNOSTNÍ SYSTÉM' ^7 vyloupení banky: ^1"
Config.PhoneHack = true -- true or false for toggle mhacking
Config.PhoneHackTime = 35
Config.PhoneHackDifficulty = 3


Config.Trolley = {
    ["cash"] = { 7000, 11000 }, -- this is what you receive every cash stack math.random(1, 2)
