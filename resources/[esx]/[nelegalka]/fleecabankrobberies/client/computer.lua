local a = {
    "NOMONEYS", "12345678", "EZMONEYS", "CREAMPIE", "ESX&SERV", "RICHPEEP"
}
cachedScaleform = nil;
...
StartComputer = function()
    Citizen.CreateThread(function()
        InitializeBruteForce = function(h)
            ...
            local i = 'hack'
            local j = 0;
            while HasAdditionalTextLoaded(j) and
                not HasThisAdditionalTextLoaded(i, j) do
                Citizen.Wait(0)
                j = j + 1
            end
        ...
        while g do
            ...
            if g then
                DrawScaleformMovieFullscreen(cachedScaleform, 255, 255, 255,
                                             255, 0)
                ...
                if IsDisabledControlJustPressed(0, 24) and not e then
                    PushScaleformMovieFunction(cachedScaleform,
