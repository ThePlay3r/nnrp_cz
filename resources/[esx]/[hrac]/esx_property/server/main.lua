...
AddEventHandler('esx_property:rentProperty', function(propertyName)
  ...
  SetPropertyOwned(propertyName, property.price / Config.RentKoeficient, true, xPlayer.identifier)
...
function PayRent(d, h, m)
  ...
  MySQL.Async.fetchAll(
    ...
    function(_users)
      ...
      for i=1, #_users, 1 do
        prevMoney[_users[i].identifier] = _users[i].bank
        newMoney[_users[i].identifier]  = _users[i].bank
      end
