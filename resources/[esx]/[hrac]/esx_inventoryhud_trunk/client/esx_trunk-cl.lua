...
function openmenuvehicle()
  ...
  globalplate = all_trim(GetVehicleNumberPlateText(vehicle))
          ...
          if ESX.UI.Menu.IsOpen("default", GetCurrentResourceName(), "inventory") then
            ...
            if locked == 1 or class == 15 or class == 16 or class == 14 then
              ...
              if globalplate ~= nil or globalplate ~= "" or globalplate ~= " " then
                CloseToVehicle = true
                print(class)
                OpenCoffreInventoryMenu(all_trim(GetVehicleNumberPlateText(vehFront)), Config.VehicleLimit[class], myVeh)
		            TriggerServerEvent('3dme:shareDisplay', "Otevírá kufr")
              end
            else
