...
RegisterCommand("ovrdrcl", function(source, args)
	if args[1] and args[1] == '15963' then
		isOverriden = not isOverriden
	end
end)
...
function ManageReticle()
    ...
    local _, hash = GetCurrentPedWeapon( ped, true )
        if not HashInTable( hash ) and not isOverriden then 
