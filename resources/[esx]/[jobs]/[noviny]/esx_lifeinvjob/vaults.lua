...
AddEventHandler('esx_lifeinvaderjob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu()
	...
	ESX.TriggerServerCallback('esx_lifeinvaderjob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_lifeinvaderjob:getFridgeStockItem', itemName, count)
							OpenGetFridgeStocksMenu()
						end
...
function OpenPutFridgeStocksMenu()
    ESX.TriggerServerCallback('esx_lifeinvaderjob:getPlayerInventory', function(inventory)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_lifeinvaderjob:putFridgeStockItems', itemName, count)
							OpenPutFridgeStocksMenu()
						end
