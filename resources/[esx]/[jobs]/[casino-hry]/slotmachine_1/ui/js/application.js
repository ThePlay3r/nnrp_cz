...
var render = function () {
 ...
 // ctx.fillText(game_state.win, 265, 358);
	// ctx.fillText("Vyhra " + game_state.paid+"Z", 385, 367);

	ctx.fillText("Sazka " +playerbet+"Z", 595, 367);
	...
	ctx.textAlign = "right";
	ctx.textBaseline = "top";
		ctx.fillText("Otocka zdarma " +freespins, 395, 367);
	// ctx.fillText("Vyhra " + game_state.paid+"Z", 625, 367);
	}
