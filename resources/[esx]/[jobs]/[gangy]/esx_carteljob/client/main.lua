    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'citizen_wear' then
       ...
       if data.current.value == 'cartel_wear' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          if skin.sex == 0 and Config.CartelStations.Cartel.Clothes['male'][PlayerData.job.grade_name] then
            TriggerEvent(
              'skinchanger:loadClothes',
              skin,
              Config.CartelStations.Cartel.Clothes['male'][PlayerData.job.grade_name]
            )
          elseif Config.CartelStations.Cartel.Clothes['female'][PlayerData.job.grade_name] then
            TriggerEvent(
              'skinchanger:loadClothes',
              skin,
              Config.CartelStations.Cartel.Clothes['female'][PlayerData.job.grade_name]
            )
          end
        end)
      end
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'cartel' then
      ...
      for k,v in pairs(Config.CartelStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'cartel' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'lowerboss1' or PlayerData.job.grade_name == 'lowerboss2') then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'cartel' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleILovePizzaInGarage', 'cartel', vehicleProps)
