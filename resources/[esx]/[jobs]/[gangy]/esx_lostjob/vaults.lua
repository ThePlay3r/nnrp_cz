...
AddEventHandler('esx_lostjob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu(society)

	ESX.TriggerServerCallback('esx_lostjob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_lostjob:getFridgeStockItem', itemName, count, society)
							OpenGetFridgeStocksMenu()
						end
...
function OpenPutFridgeStocksMenu(society)
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_lostjob:putFridgeStockItems', itemName, count, society)
							OpenPutFridgeStocksMenu()
						end
