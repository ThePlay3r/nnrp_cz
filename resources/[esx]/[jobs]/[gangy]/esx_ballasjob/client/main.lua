    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'citizen_wear' then
       ...
       if data.current.value == 'ballas_wear' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          if skin.sex == 0 and Config.BallasStations.Ballas.Clothes['male'][PlayerData.job.grade_name] then
            TriggerEvent(
              'skinchanger:loadClothes',
              skin,
              Config.BallasStations.Ballas.Clothes['male'][PlayerData.job.grade_name]
            )
          elseif Config.BallasStations.Ballas.Clothes['female'][PlayerData.job.grade_name] then
            TriggerEvent(
              'skinchanger:loadClothes',
              skin,
              Config.BallasStations.Ballas.Clothes['female'][PlayerData.job.grade_name]
            )
          end
        end)
      end
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'ballas' then
      ...
      for k,v in pairs(Config.BallasStations) do
        ...
        if PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'gangster' or PlayerData.job.grade_name == 'lowerboss1' then
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'lowerboss1') then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleILovePizzaInGarage', 'ballas', vehicleProps)
