...
function OpenSocietyActionsMenu()
  ...
  table.insert(elements, {label = 'Interakce s obcanem', value = 'citizen_interaction'})
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'unicorn_actions', {
      ...
      if data.current.value == 'citizen_interaction' then
        ...
        ESX.UI.Menu.Open(
          ...
          {
            title    = 'Interakce s obcanem',
            align    = 'top-left',
            elements = {
              {label = 'Prohledat',        value = 'body_search'},
              {label = 'Spoutat/Odpoutat',    value = 'handcuff'},
              {label = 'Prenest',      value = 'drag'},
              {label = 'Posadit do vozidla',  value = 'put_in_vehicle'},
              {label = 'Vysadit z vozidla', value = 'out_the_vehicle'},
            },
          },
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleILovePizzaInGarage', 'unicorn', vehicleProps)
          else
