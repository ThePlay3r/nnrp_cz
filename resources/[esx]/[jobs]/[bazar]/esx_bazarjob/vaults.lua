...
AddEventHandler('esx_bazarjob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu()
	...
	ESX.TriggerServerCallback('esx_bazarjob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_bazarjob:getFridgeStockItem', itemName, count)
							OpenGetFridgeStocksMenu()
						end
...
function OpenPutFridgeStocksMenu()
    ESX.TriggerServerCallback('esx_bazarjob:getPlayerInventory', function(inventory)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_bazarjob:putFridgeStockItems', itemName, count)
							OpenPutFridgeStocksMenu()
						end
