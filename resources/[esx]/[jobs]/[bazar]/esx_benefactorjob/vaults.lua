...
AddEventHandler('esx_benefactorjob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu()
	...
	ESX.TriggerServerCallback('esx_benefactorjob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_benefactorjob:getFridgeStockItem', itemName, count)
							OpenGetFridgeStocksMenu()
						end
...
function OpenPutFridgeStocksMenu()
    ESX.TriggerServerCallback('esx_benefactorjob:getPlayerInventory', function(inventory)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_benefactorjob:putFridgeStockItems', itemName, count)
							OpenPutFridgeStocksMenu()
						end
