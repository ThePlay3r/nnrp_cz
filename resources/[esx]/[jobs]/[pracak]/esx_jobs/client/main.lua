							...
							if playerPed == driverPed then
								...
								for i=1, #myPlate, 1 do
									if myPlate[i] == plate then
										...
										TriggerServerEvent('esx_jobs:caILovePizzaution', "give_back", giveBack, 0, 0)
...
function spawnVehicle(spawnPoint, vehicle, vehicleCaution)
	hintToDisplay = 'no hint to display'
	hintIsShowed = false
	TriggerServerEvent('esx_jobs:caILovePizzaution', 'take', vehicleCaution, spawnPoint, vehicle)
end
