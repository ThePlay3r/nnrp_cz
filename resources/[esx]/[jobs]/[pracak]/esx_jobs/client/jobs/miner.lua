	...
	Zones = {
		...
		Foundry = {
			...
			Item = {
				...
				{
					name = _U("m_silver_ingot"),
					db_name = "silver_ingot",
					max = 20,
					add = 1,
					drop = 50
				},
		...
		IronDelivery = {
			...
			Item = {
				{
					...
					time = 1500,
					remove = 1,
					max = 350, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 50,
					requires = "iron",
			...
			GPS = {x = 303.61, y = -276.63, z = 53.17}
		},

		SilverDelivery = {
			Pos = {x = 303.61, y = -276.63, z = 53.17},
			Color = {r = 204, g = 204, b = 0},
			Size = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
			Blip = true,
			Name = _U("m_sell_silver_ingot"),
			Type = "delivery",
			Spawner = 1,
			Item = {
				{
					...
					price = 120,
					requires = "silver_ingot",
					requires_name = _U("m_silver_ingot"),
					drop = 50
				}
			},
			Hint = _U("m_deliver_silver_ingot"),
