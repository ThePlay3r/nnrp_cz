...
AddEventHandler('esx_coffeejob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu()
	...
	ESX.TriggerServerCallback('esx_coffeejob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_coffeejob:getFridgeStockItem', itemName, count)
							OpenGetFridgeStocksMenu()
						end
...
function OpenPutFridgeStocksMenu()
    ESX.TriggerServerCallback('esx_coffeejob:getPlayerInventory', function(inventory)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_coffeejob:putFridgeStockItems', itemName, count)
							OpenPutFridgeStocksMenu()
						end
