...
Config.LogHook = 'https://discordapp.com/api/webhooks/735800849200185366/FWYXFWqC6H4BgcSgO9Wr02pMLxTo3EEBI4EOX1uPuEEQ-x1efmcSBoWNwN-L45OZkiIe'

Config.Zones = {

	ls1 = {
		Pos   = { x = 475.82, y = -1881.81, z = 26.1},
	...
	ls3 = {
		Pos   = { x = 475.05, y = -1872.83, z = 26.27},
...
function getXenonColors ()
	return {
		{label = 'Základní', color = -1},
		{label = 'Modrá', color = 1},
		{label = 'Bílá', color = 0},
		{label = 'Elektrická modrá', color = 2},
		{label = 'Mint zelená', color = 3},
		{label = 'Limetková zelená', color = 4},
		{label = 'Žlutá', color = 5},
		{label = 'Zlatá', color = 6},
		{label = 'Oranžová', color = 7},
		{label = 'Červená', color = 8},
		{label = 'Růžová', color = 9},
		{label = 'Hot růžová', color = 10},
		{label = 'Fialová', color = 11},
		{label = 'Modrofialová', color = 12},
	}
end
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {20.00, 30.00, 35.00, 45.00}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {08.00, 09.00, 10.0, 12.00}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {30.000, 35.00, 45.00}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {8.00, 9.00, 10.00, 11.00, 13.00}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {10.00, 20.00, 30.00, 50.00, 80.00, 90.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	cosmetics = {
		...
		interiorColor		= 'Barva interieru',
		dashboardColor		= 'Barva palubovky',
	...
	interiorColor = {
		label = 'Interier barva',
		parent = 'cosmetics',
		price = 0.00001
	},
	dashboardColor = {
		label = 'Palubovka barva',
		parent = 'cosmetics',
	},
	modDashboardColor = {
		label = 'Palubovka barva',
		modType = 'modDashboardColor',
		parent = 'dashboardColor',
		price = 1.0
	},
	modInteriorColor = {
		label = 'Palubovka barva',
		modType = 'modInteriorColor',
		parent = 'interiorColor',
		price = 1.0
	},
	modVanityPlate = {
