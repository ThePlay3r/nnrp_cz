...
RegisterServerEvent('esx_mechanicjob:starILovePizzatCraft')
AddEventHandler('esx_mechanicjob:starILovePizzatCraft', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starILovePizzatCraft2')
AddEventHandler('esx_mechanicjob:starILovePizzatCraft2', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starILovePizzatCraft3')
AddEventHandler('esx_mechanicjob:starILovePizzatCraft3', function()
	local _source = source
