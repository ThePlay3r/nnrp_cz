...
Config.AuthorizedVehicles = {
	{model = 'flatbed3', label = 'Odtahovka', price = 1, props = {modLivery = 2}},
	{model = 'nspeedofiremni', label = 'Vapid Speedo', price = 1, props = {modLivery = 11}},
}
Config.ShopCoords = {
	coords = vector3(466.91, -1889.04, 30.0),
	heading = 201.27,
}
Config.SpawnPoints = {
	{coords = vector3(457.18, -1886.38, 26.15), heading = 204.36, radius = 2.0},
}

Config.Clothes = {
	male = {
		['tshirt_1'] = 93, ['tshirt_2'] = 1,
		['torso_1'] = 277, ['torso_2'] = 20,
		['arms'] = 32,
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = 475.88, y = -1900.64, z = 24.95 },
	...
	Cloakroom = {
		Pos = vector3(471.44, -1902.93, 24.7),
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	Garage = {
		Pos   = { x = -562.39, y = -1685.61, z = 18.28 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawner = {
		Pos = vector3(455.81, -1892.92, 26.17),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 32, g = 102, b = 148 },
		Type  = 36,
	},
	...
	VehicleDelivery = {
		Pos   = { x = 456.71, y = -1883.02, z = 26.25 },
