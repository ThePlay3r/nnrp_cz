...
AddEventHandler('esx_easywayjob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu()
	...
	ESX.TriggerServerCallback('esx_easywayjob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_easywayjob:getFridgeStockItem', itemName, count)
							OpenGetFridgeStocksMenu()
						end
...
function OpenPutFridgeStocksMenu()
    ESX.TriggerServerCallback('esx_easywayjob:getPlayerInventory', function(inventory)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_easywayjob:putFridgeStockItems', itemName, count)
							OpenPutFridgeStocksMenu()
						end
