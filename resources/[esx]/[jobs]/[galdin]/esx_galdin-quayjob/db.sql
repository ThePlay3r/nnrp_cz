SET @job_name = 'galdin';
SET @society_name = 'society_galdin';
SET @job_Name_Caps = 'galdin';
...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
  (@job_name, 0, 'newbie', 'Zasobovac', 1500, '{}', '{}'),
  (@job_name, 1, 'waiter', 'Cisnik', 2000, '{}', '{}'),
  (@job_name, 2, 'barman', 'Barman', 2500, '{}', '{}'),
  (@job_name, 3, 'probarman', 'Barmanske eso', 3000, '{}', '{}'),
  (@job_name, 4, 'accountant', 'Ucetni', 3500, '{}', '{}')
  (@job_name, 5, 'boss', 'Majitel', 4000, '{}', '{}')
;
