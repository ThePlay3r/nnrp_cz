...
AddEventHandler('napojak:hasEnteredMarker', function()
    isInZone = true
end)

AddEventHandler('napojak:hasExitedMarker', function()
    isInZone = false
    CloseNapojak()
end)
...
Citizen.CreateThread(function()
	while true do
        ...
        if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
            ...
            TriggerEvent('napojak:hasEnteredMarker')
        end

        if not isInMarker and HasAlreadyEnteredMarker then
            HasAlreadyEnteredMarker = false
            TriggerEvent('napojak:hasExitedMarker')
        end
	end
end)
