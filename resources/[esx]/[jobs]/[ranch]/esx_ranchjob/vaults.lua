...
AddEventHandler('esx_ranchjob:openVaultMenu', function()
	local elements = {
...
function OpenGetFridgeStocksMenu()
	...
	ESX.TriggerServerCallback('esx_ranchjob:getFridgeStockItems', function(items)
		local elements = {}
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_ranchjob:getFridgeStockItem', itemName, count)
							OpenGetFridgeStocksMenu()
						end
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil then
							...
							menu2.close()
							menu.close()
							TriggerServerEvent('esx_ranchjob:putFridgeStockItems', itemName, count)
							OpenPutFridgeStocksMenu()
						end
