...
TriggerEvent('es:addGroupCommand', 'clearinstance', 'user', function(source, args, user)
	CloseInstance(source)
	TriggerClientEvent('esx:showNotification', source, 'Instance vyresetovana')
end)

TriggerEvent('es:addGroupCommand', 'clearinstances', 'helper', function(source, args, user)
	instances = {}
end)