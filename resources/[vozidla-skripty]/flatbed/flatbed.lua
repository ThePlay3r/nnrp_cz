...
AddTextEntry(controllerMessageLoweredCar, "Stiskni ~INPUT_CONTEXT~ k ~y~vysunutí ~w~plošiny.~n~Stiskni ~INPUT_DETONATE~ k ~r~povolení ~w~vozidla.")
AddTextEntry(controllerMessageLoweredNoCar, "Stiskni ~INPUT_CONTEXT~ k ~y~zasunutí ~w~plošiny.~n~Stiskni ~INPUT_DETONATE~ k ~g~upevnení ~w~ vozidla.")
AddTextEntry(controllerMessageRaised, "Stiskni ~INPUT_CONTEXT~ k ~y~vysunutí~w~ plošiny")
