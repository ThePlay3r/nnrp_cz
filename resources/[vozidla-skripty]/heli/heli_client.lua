...
local sheriff_hash = GetHashKey("sherheli")
...
function IsPlayerInPolmav()
	...
	local isPedNotDriver = GetPedInVehicleSeat(vehicle, -1) ~= lPed
	return isPedNotDriver and (IsVehicleModel(vehicle, polmav_hash) or IsVehicleModel(vehicle, sheriff_hash))
end
