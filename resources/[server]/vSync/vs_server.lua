...
local defaultNewWeatherTime = 10
local newWeatherTimer = defaultNewWeatherTime
    ...
    if source == 0 then
        ...
        if args[1] == nil then
            ...
            if validWeatherType then
                ...
                newWeatherTimer = defaultNewWeatherTime
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
        local newBaseTime = os.time(os.date("!*t")) / 4 + 360
