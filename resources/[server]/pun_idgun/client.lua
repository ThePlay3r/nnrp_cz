    ...
    while true do                                           -- Loop it infinitely.
        ...
        if infoOn then                                      -- If the info is on then...
            ...
            if IsPlayerFreeAiming(PlayerId()) then          -- If the player is free-aiming (update texts)...
                ...
                local playerName = GetPlayerName(NetworkGetEntityOwner(entity))
                owner = playerName
            ...
            DrawInfos("Coords: " .. coordsText .. "\nHeading: " .. headingText .. "\nHash: " .. modelText)     -- Draw the text on screen

            if owner ~= '**Invalid**' and owner ~= '' then
                DrawInfos2("Rotation: " .. rotationText .. "\nOwner: " .. owner)     -- Draw the text on screen
            else
                DrawInfos2("Rotation: " .. rotationText)     -- Draw the text on screen
            end
