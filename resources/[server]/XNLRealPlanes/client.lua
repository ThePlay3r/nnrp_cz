...
XNL_PlaneCropDuster_AllowAutoPilot = true		-- Setting: IF this plane is allowed to use autopilot (when meeting the right conditions!)
...
XNL_EngineAlarm = true							-- Remembers if Engine Alarm has been activated
XNL_EngineAlarm2 = true						-- Remembers if Engine Alarm 2 has been activated
...
XNL_TakeOffCompleted = true					-- This tells the system that it has completed take off procedure
...
function GetCurrentAircraftSetting(EntityModel)
	...
	if IsThisModelAHeli(EntityModel) then
		...
		GPWS_CruiseHeightOK				= 0.0	
		GPWS_CruiseHeightMax 			= 0.0
