            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = {"Tleskat", "Tleskat ironicky", "Složit ruce", "Opřít se", "Rozpažit"},
                    commands = {"e cheer", "e slowclap", "e foldarms", "e lean", "e t"}
                },
                {
                    navAngle = 285,                 -- Oritentation of wheel
                    minRadiusPercent = 0.6,         -- Minimum radius of wheel in percentage
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"Salutovat", "Fakač", "Mír", "Mrtvy", "Sundat SPZ", "Nasadit SPZ", "Unést"},
                    commands = {"e salute", "e finger", "e peace", "e passout4", "removeplate", "putplate", "carry"}
                }
            }
        }
    },
            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"imgsrc:engine.png", "imgsrc:key.png", "imgsrc:doors.png", "imgsrc:trunk.png", "imgsrc:hood.png", "imgsrc:rollw.png"},
                    commands = {"engine", "lock", "rdoors", "trunk", "hood", "rollw"}
                }
            }
        }
    }
